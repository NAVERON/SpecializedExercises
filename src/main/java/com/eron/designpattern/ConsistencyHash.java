...
public class ConsistencyHash {
    ...
    private TreeMap<Long, String> virtualHash2RealNode = new TreeMap<Long, String>();  // 红黑树 顺序存储
    ...
    public void initVirtual2RealRing(List<String> shards) {
        ...
        for (String node : shardNodes) {
            for (int i = 0; i < NODE_NUM; i++) {  // 一个节点虚拟出100 份 
    ...
    public String getShardInfo(String key) {
        ...
        SortedMap<Long, String> tailMap = virtualHash2RealNode.tailMap(hashCode);  // 获取大于等于当前key的值 
        if (tailMap.isEmpty()) {
    ...
    public static void main(String[] args) {
        ...
        /*
         * long start = System.currentTimeMillis(); for (int i = 0; i < 1000 * 1000 *
         * 1000; i++) { if (i % (100 * 1000 * 1000) == 0) { System.out.println(i + ":" +
         * hash("key1" + i)); } } long end = System.currentTimeMillis();
